...
<div class="container">
	<div class="row py-5 mt-4 align-items-center">
		...
		<div class="col-md-5 pr-lg-5 mb-5 mb-md-0">
			<img src="images/logic.png" alt="" class="img-fluid mb-3 d-none d-md-block" width="500px" height="200px">
			...
			<form action="AdminData" method = "post">
				<div class="row">
					...
					<div class="input-group col-lg-12 mb-4">
						...
						<input type="text" id="job" name="Instituute_name" placeholder="Institute_name" class="form-control custom-select bg-white border-left-0 border-md">
					</div>
                    <!-- location  -->
                    <div class="input-group col-lg-12 mb-4">
						<div class="input-group-prepend">
					...
					<div class="form-group col-lg-12 mx-auto mb-0">
						<a href="#" class="btn btn-primary btn-block py-2">
							<input type = "submit" class="font-weight-bold aditi" Value = "Create your account">
						</a>
					</div>
